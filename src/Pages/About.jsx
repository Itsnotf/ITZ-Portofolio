    ...
    return (
        <div className='flex w-screen h-auto md:mt-[40px] mt-[80px]  md:flex-row flex-col'>
            ...
            <div className='md:mt-[80px] mt-[30px] md:text-[36px] text-[20px] font-semibold font-Poppins md:w-[50%] w-[100%] md:text-left text-center text-[#213C57]'>
                <h1 className=' md:block hidden'> Saya adalah Mahasiswa jurusan <span className='text-[#DFAA74]'>Manajemen Informatika</span> di <span className='text-[#DFAA74]'>Politeknik Negeri Sriwijaya</span>, dan sekarang saya ada di semester 3.</h1>

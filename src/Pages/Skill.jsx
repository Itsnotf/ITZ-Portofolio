    ...
    return (
        <div className='w-full  h-auto  flex flex-col overflow-hidden   '>
            <div className='w-full h-auto flex flex-row md:mx-[100px] md:mt-10'>
                <div className='flex  mx-[10px] mt-[100px] md:text-[60px] text-[30px] md:w-[680px] w-auto text-[#213C57] font-semibold md:text-start text-center leading-tight font-Poppins'>
                    <p>My Mission Is <span className='text-orange-200'>Design & Develop </span>the best website around</p>
                </div>
            </div>
            <div className='flex pb-20 md:mx-[100px]  mx-[0px] justify-center  gap-x-[120px] flex-wrap'>
